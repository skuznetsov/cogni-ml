# CogniGemma CUDA full SWA-layer composition smoke.
#
# Composes one Gemma4 SWA layer through attention, residual/norm, GELU FFN,
# post-FFW norm, final residual, and layer-output scale.
...
OptionParser.parse do |p|
  p.banner = "Usage: gemma4_cuda_swa_layer_probe [--model PATH] [--layer N] [--tokens N] [--base-pos N] [--splitk-chunk N] [--reps N] [--warmup N] [--seed N]"
...
begin
  ...
  gelu_mod = ML::CUDA::CUDAModule.load(GELU_ADD_PTX, "gemma4_swa_layer_elem")
