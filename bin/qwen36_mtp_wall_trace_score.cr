#!/usr/bin/env crystal
# Score simple verifier-submit policies over qwen35_mtp_sidecar_probe router traces.
# Runtime-legal policies here use MTP features available after proposal but before
# exact verifier submission. Target-margin policies are printed as oracle-only.
...
OptionParser.parse do |p|
  p.banner = "Usage: qwen36_mtp_wall_trace_score TRACE.jsonl [TRACE2.jsonl ...] [--thresholds LIST] [--include-target-oracle]"
