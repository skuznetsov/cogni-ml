...
policy_names = ["default", "guard", "bootstrap32", "bootstrap32_s2", "bootstrap32_guard", "router16", "router16_staged", "fixed16", "staged16", "hybrid", "target_only", "ngram", "ngram_risk", "ngram_replay", "ngram_replay_risk", "ngram_target_only", "ngram_target_only_min8", "ngram_target_only_probe1", "ngram_target_only_probe2", "ngram_target_only_risk", "ngram_target_only_risk_min8", "ngram_target_only_risk_min8_model", "ngram_target_only_risk_min8_model_long08", "ngram_target_only_risk_min12", "ngram_target_only_risk_min16", "ngram_target_only_staged", "ngram_target_only_staged_risk", "ngram_target_only_staged_corridor_min6", "ngram_target_only_staged_replay_risk", "ngram_target_only_replay_risk", "ngram_bootstrap32_s2", "ngram_router16", "ngram_router16_risk", "ngram_router16_staged", "ngram_router16_staged_risk", "ngram_router16_staged_model", "ngram_fixed16", "ngram_staged16", "ngram_guard"]
...
OptionParser.parse(ARGV) do |p|
  ...
  p.on("--policies LIST", "Comma-separated policies: default,guard,bootstrap32,bootstrap32_s2,bootstrap32_guard,router16,router16_staged,fixed16,staged16,hybrid,target_only,ngram,ngram_risk,ngram_replay,ngram_replay_risk,ngram_target_only,ngram_target_only_min8,ngram_target_only_probe1,ngram_target_only_probe2,ngram_target_only_risk,ngram_target_only_risk_min8,ngram_target_only_risk_min8_model,ngram_target_only_risk_min8_model_long08,ngram_target_only_risk_min12,ngram_target_only_risk_min16,ngram_target_only_staged,ngram_target_only_staged_risk,ngram_target_only_staged_corridor_min6,ngram_target_only_staged_replay_risk,ngram_target_only_replay_risk,ngram_bootstrap32_s2,ngram_router16,ngram_router16_risk,ngram_router16_staged,ngram_router16_staged_risk,ngram_router16_staged_model,ngram_fixed16,ngram_staged16,ngram_guard; *_guard explicitly enables research-only guarded verifier") do |v|
...
if policy_names.any?(&.ends_with?("_model"))
  raise "--router-model is required when selecting *_model policies" unless router_model_path && File.file?(router_model_path.not_nil!)
end

model_args = router_model_path ? ["--router-model", router_model_path.not_nil!] : [] of String
...
policies = {
  ...
  "router16_staged"                          => Policy.new("router16_staged", ["--gamma", "4", "--max-gamma", "16", "--bootstrap-gamma", "16", "--bootstrap-streak", "1", "--verify", "staged", "--stage-gate", "4"], {} of String => String),
  ...
  "target_only"                              => Policy.new("target_only", ["--target-only"], {} of String => String),
  "ngram"                                    => Policy.new("ngram", ["--ngram"], {} of String => String),
  "ngram_risk"                               => Policy.new("ngram_risk", ["--ngram", "--ngram-risk-gate"], {} of String => String),
  ...
  "ngram_target_only_min8"                   => Policy.new("ngram_target_only_min8", ["--ngram", "--ngram-target-only", "--ngram-min-candidates", "8"], {} of String => String),
  ...
  "ngram_target_only_risk_min8_model_long08" => Policy.new("ngram_target_only_risk_min8_model_long08", ["--ngram", "--ngram-risk-gate", "--ngram-target-only", "--ngram-min-candidates", "8", "--router-long-threshold", "0.8", "--router-long-min", "16"] + model_args, {} of String => String),
  ...
  "ngram_target_only_staged_corridor_min6"   => Policy.new("ngram_target_only_staged_corridor_min6", ["--ngram", "--ngram-risk-gate", "--ngram-target-only", "--verify", "staged", "--stage-gate", "4", "--ngram-stage-min", "8", "--ngram-corridor-gate", "--ngram-corridor-match-len-min", "8", "--ngram-corridor-lag8-min", "1.0", "--ngram-min-candidates", "6"], {} of String => String),
  "ngram_target_only_staged_replay_risk"     => Policy.new("ngram_target_only_staged_replay_risk", ["--ngram", "--ngram-risk-gate", "--ngram-replay-on-reject", "--ngram-target-only", "--verify", "staged", "--stage-gate", "4", "--ngram-stage-min", "8"], {} of String => String),
  "ngram_target_only_replay_risk"            => Policy.new("ngram_target_only_replay_risk", ["--ngram", "--ngram-risk-gate", "--ngram-replay-on-reject", "--ngram-target-only"], {} of String => String),
