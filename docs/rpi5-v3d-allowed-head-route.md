...
5. Build a real `QWEN35_RPI5_RESIDENT_COMMAND_JSON` SSH/Vulkan command for the Pi probe and run a constrained tool-call parity smoke with `QWEN35_ALLOWED_HEAD_CPU_MAX=7`.
