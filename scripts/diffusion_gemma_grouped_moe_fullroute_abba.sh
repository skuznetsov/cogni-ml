...
variant_env="${base_env} DIFFUSION_GEMMA_MOE_GROUPED_EXPERT_ROWS=1 DIFFUSION_GEMMA_MOE_GROUPED_EXPERT_MIN_CANVAS=${min_canvas} DIFFUSION_GEMMA_MOE_GROUPED_EXPERT_MAX_CANVAS=${max_canvas}"
