...
mkdir -p "$(dirname "$out")"
printf 'status\tcase\tprompt_bytes\tprompt_len\tcanvas_len\tcandidate_count\tload_ms\tprompt_route_ms\tprompt_projection_backend\tprompt_cache_ms\tprompt_projection_ms\tprompt_materialize_ms\tprompt_cache_ms_samples\tprompt_projection_ms_samples\tprompt_materialize_ms_samples\tprompt_cache_tokens_per_ms\tloop_ms_median\tloop_ms_samples\tloop_prediction_ms\tloop_decode_stack_ms\tloop_output_head_ms\tloop_update_ms\tloop_regenerate_ms\tloop_proposal_ms\tloop_prediction_ms_samples\tloop_decode_stack_ms_samples\tloop_output_head_ms_samples\tloop_update_ms_samples\tloop_regenerate_ms_samples\tloop_proposal_ms_samples\tchosen\tprobs\tartifact\terr_artifact\n' >"$out"
