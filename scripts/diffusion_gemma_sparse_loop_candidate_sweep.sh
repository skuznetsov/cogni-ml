...
raw_tsv="${SUMMARY_RAW_TSV:-$summary_dir/diffusion_gemma_sparse_loop_candidate_sweep_${stamp}.tsv}"
summary_tsv="${SUMMARY_TSV:-$summary_dir/diffusion_gemma_sparse_loop_candidate_sweep_${stamp}.summary.tsv}"

"$out" --candidate-counts "$counts_csv" --format tsv "$@" >"$raw_tsv"
