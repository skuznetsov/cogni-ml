...
// Same math as qwen35_attn_decode_rows, but packs four consecutive query rows
// for the same head into one threadgroup. Each simdgroup owns one token row.
// This is an exact scheduling variant: KV cache layout, causal boundary, online
// softmax, and output values are unchanged.
